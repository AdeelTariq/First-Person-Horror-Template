@tool
class_name DownScalePostProcess extends CompositorEffect

@export var factor: float = 4.0
...
func init_compute_shader() -> void :
	...
	var glsl_file: RDShaderFile = load("res://shaders/retro/downscale.glsl")
